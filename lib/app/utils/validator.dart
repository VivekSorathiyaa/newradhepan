class Validators {
  static String? validateDigits(String value, String type) {
...
//   }
  ...
  static String? validateMobile(String value) {
    String pattern = r'^[0-9]{10}$'; // Regex pattern for exactly 10 digits
  ...
  static String? validateName(String? value, String type) {
    ...
    if (value == null || value.isEmpty) {
      ...
      return "$type has only enter characters, no special character or digit";
    } else {
      return null;
    }
  }

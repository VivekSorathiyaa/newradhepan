...
class AppConstants {
  ...
  static String apiEndPoint = "https://api.radhe.app/"; // live
  ...
  // static String imageEndPoint = "https://radhe-api.s3.us-west-2.amazonaws.com/";
  static String imageEndPoint =
      "https://radhe-files.s3.ap-southeast-2.amazonaws.com/";
